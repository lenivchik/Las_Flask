...
class HeaderItem(OrderedDict):
    ...
    def set_session_mnemonic_only(self, value):
        ...
        See source comments for :class:`lascheck.las_items.HeaderItem.__init__`
...
class CurveItem(HeaderItem):
    ...
    See :class:`lascheck.las_items.HeaderItem`` for the (keyword) arguments.
...
class SectionItems(list):
    ...
    def __setitem__(self, key, newitem):
        ...
        See :meth:`lascheck.las_items.SectionItems.set_item` and
        :meth:`lascheck.las_items.SectionItems.set_item_value`.
    ...
    def __setattr__(self, key, value):
        '''Allow access to :meth:`lascheck.las_items.SectionItems.__setitem__`
